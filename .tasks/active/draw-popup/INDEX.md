...
|----|------|--------|------------|----------|
| 001 | DrawPopup component (overlay, animated ball, auto-dismiss, aria-live, CSS keyframes) | ready | — | Component Builder |
| 002 | Wire popup into player + admin pages | blocked | 001 | Component Builder |
| 003 | i18n translations (pt + en) for aria announcement | blocked | 001, 002 | Component Builder |
